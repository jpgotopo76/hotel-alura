...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		labelRegistro.setFont(new Font("Montserrat", Font.PLAIN, 18));
		...
		lblBusquedaDeReservas.setFont(new Font("Montserrat", Font.PLAIN, 18));
	    ...
	    panelFecha.setBackground(new Color(255, 128, 0));
	    ...
	    lblNewLabel_1.setFont(new Font("Montserrat", Font.PLAIN, 24));
	    
	    JLabel labelFecha = new JLabel("New label");
	    labelFecha.setBounds(35, 64, 294, 36);
	    panelFecha.add(labelFecha);
	    labelFecha.setForeground(Color.WHITE);
	    labelFecha.setFont(new Font("Montserrat", Font.PLAIN, 33));
	    ...
	    JLabel labelDescripcion = new JLabel("<html><body>Sistema de reserva de hotel Alura atendido por su dueño Jean Paul Gotopo. Controle y administre de forma óptima y fácil  el flujo de reservas y de huespédes del hotel   </body></html>");
	    labelDescripcion.setFont(new Font("Montserrat", Font.PLAIN, 17));
	    ...
	    labelDescripcion_1.setFont(new Font("Montserrat", Font.PLAIN, 17));
