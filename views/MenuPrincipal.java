...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Jean Paul Gotopo © 2023");
		lblCopyR.setBounds(315, 11, 353, 19);
		...
		lblTitulo.setFont(new Font("Montserrat SemiBold", Font.PLAIN, 20));
